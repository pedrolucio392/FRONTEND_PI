...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (token) {
        ...
        authButton.innerHTML =
            '<i class="fas fa-user login-icon"></i> Logado. Sair?';
        ...
        authButton.innerHTML = '<i class="fas fa-user login-icon"></i> Login';
        authButton.addEventListener("click", () => {
            window.location.href = "login.html";
        });
    }
...
// Função para dividir um array em grupos de um certo tamanho
